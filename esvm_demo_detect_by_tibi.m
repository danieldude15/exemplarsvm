...
function esvm_demo_detect_by_tibi(test_set)


addpath(genpath(pwd));

if ~exist('cls','var')
  fprintf(1,'esvm_demo_train_fast: defaulting to class=hammer\n');
  cls = 'hammer';
end

if ~exist('data_directory','var')
  data_directory = '/media/cky800/1tb/datasets/VOCdevkit/';
end
...
if ~exist('results_directory','var')
  results_directory = '/media/cky800/1tb/datasets/hammer_test2/';
end
...
%% Show top detections
maxk = 20;
%models{1}.d3I = '/home/cky800/Downloads/hammerOrto.png';
